...
import com.experiments.android.domain.repository.FakeAndroidTxnRepository
...
class LegacyTxnListFragmentTest {
    ...
    fun activeTaskDetails_DisplayedInUi() = runBlockingTest {
        ...
        launchFragmentInContainer<LegacyTxnListFragment>(Bundle(), R.style.Theme_Experiments)
...
//            .check(matches(withText("two")))
    ...
    fun clickItem_navigateTo() = runBlockingTest {
        ...
        val scenario = launchFragmentInContainer<LegacyTxnListFragment>(Bundle(), R.style.Theme_Experiments)
